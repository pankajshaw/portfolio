    ...
    return (
        <div className="profile">
            ...
            <div className="profile__contact">
                <a href="https://drive.google.com/file/d/1fysHPe6S8IqKzxKYSF1aDCXMlyzfJEn-/view?usp=sharing" target="_blank" rel="noreferrer">
                        <span>
                            Download CV
                        </span>
                </a>
                <a href="mailto:shawpankaj30@gmail.com">
                        <span>
                            Contact Me
                        </span>
                </a>
