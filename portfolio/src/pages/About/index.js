        ...
        <div className="page" id="about">
            ...
            <div className="row">
                <div className="column">
                    <strong>
                        Hi, I am Pankaj Kr. Shaw
                    </strong>
                    <p>
                        Self-taught, self-driven, passionate learner and developer focusing on React,Angular 1.X, Node, and JavaScript Technologies. Looking forward to working with ingenious teams on challenging projects.
                        <br/> <br/>
