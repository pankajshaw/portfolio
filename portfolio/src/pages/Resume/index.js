    ...
    return (
        <div className="page" id="resume">
            <Title icon={'fa fa-briefcase'}>
                Resume - Total Commercial Experience {moment().diff('09/07/2017', 'years', true).toFixed(2)} years
            </Title>
            <ResumeItem
            ...
            >
                ...
                • Develop CSS with SCSS and BEM from Wireframe-Figma. <a href="https://tjm-forsikring.dk/" target="_blank" >TJM Forsikring</a> <br/>
